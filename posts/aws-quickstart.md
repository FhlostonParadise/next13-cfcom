...
Next.JS version 13 was released right around the same time I decided to build this site. It seemed like the perfect opportunity to jump back into the ecosystem. I choose Tailwind CSS for styling.
